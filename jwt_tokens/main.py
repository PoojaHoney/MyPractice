...
# (declared in a dependency) to define the security scheme in OpenAPI because
#  it inherits from fastapi.security.oauth2.OAuth2,
#  which in turn inherits from fastapi.security.base.SecurityBase.

#All the security utilities that integrate with OpenAPI 
# (and the automatic API docs) inherit from SecurityBase,
